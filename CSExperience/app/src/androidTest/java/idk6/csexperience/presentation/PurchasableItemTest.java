...
import idk6.csexperience.presentation.NavActivity;
...
public class PurchasableItemTest {
    ...
    @Test
    public void purchasableItemTest() {
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.buttonCoffee), withText("Buy!"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.scrollViewItems),
                                        0),
                                2)));
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.buttonBeer), withText("Buy!"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.scrollViewItems),
                                        0),
        ...
        ViewInteraction appCompatButton5 = onView(
                allOf(withId(R.id.buttonSnacks), withText("Buy!"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.scrollViewItems),
                                        0),
