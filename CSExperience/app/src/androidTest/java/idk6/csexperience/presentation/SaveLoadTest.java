...
public class SaveLoadTest {
    ...
    public void saveLoadTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.gameName),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("SAVEANDLOAD"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.gameName), withText("SAVEANDLOAD"),
                        childAtPosition(
                                allOf(withId(R.id.nameMain),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.buttonLoad2), withText("Load Slot 2"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.scrollViewLoad),
                                        0),
                                3)));
