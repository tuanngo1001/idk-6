...
import idk6.csexperience.presentation.Messages;

/*
    Methods in this class were ripped straight from HomeActivity.java in the sample project
 */
...
public class DatabaseSetupHelper {
    ...
    public static void copyDatabaseToDevice(Context context) {
        ...
        try {
            ...
            Messages.warning((Activity) context, "Unable to access application data: " + ioe.getMessage());
        }
    }
